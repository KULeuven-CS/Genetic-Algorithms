...
\usepackage[a5paper, tmargin=2cm, bmargin=2cm]{geometry}
\usepackage[backend=bibtex,style=ieee]{biblatex}
...
\subfile{subfiles/preservation.tex}

\chapter{Questions}
\subfile{subfiles/questions.tex}g
