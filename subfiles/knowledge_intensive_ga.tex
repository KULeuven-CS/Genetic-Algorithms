...
% the same time: it achieves very high performance for all kinds of problems. It also clearly outperforms GABIL in terms
% of learning variability. Its smooth learning curve indicates low variability in performance, while the broken curve of
